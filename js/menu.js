var Menu = (function() {
	...
	var $container = $( '#container' ),
		$cover = $container.find( 'div.cover' ),
		$middle = $container.find( 'div.middle' ),
		$right = $container.find( 'div.right' ),
		$open = $cover.find('div.open'),
		$close = $right.find('span.close'),
		...
		closeMenu = function() {
			...
			$container.removeClass( 'open nodelay in' );
